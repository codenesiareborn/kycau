...
>
    <div class="fi-wi-stats-overview-stat-content">
        ...
        <div class="fi-wi-stats-overview-stat-value" style="@if(str_contains(($getExtraAttributeBag() ?? new \Illuminate\View\ComponentAttributeBag)->get('class') ?? '', 'stats-overview-widget-large')) font-size: 0.875rem !important; font-weight: 700 !important; @else font-size: 0.75rem !important; font-weight: 600 !important; @endif line-height: 1.2 !important;">
            {{ $getValue() }}
        </div>
